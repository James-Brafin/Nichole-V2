...
internal sealed class FlexStrike : Card, ICard
{
    ...
    public static void Register(IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("FlexStrike", new()
        {
            ...
            Name = ModEntry.Instance.AnyLoc.Bind(["card", "FlexStrike", "name"]).Localize
        });
    }
