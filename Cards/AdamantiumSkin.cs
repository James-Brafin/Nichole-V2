...
internal sealed class AdamantiumSkin : Card, ICard, IHasCustomCardTraits
{
    /* For a bit more info on the Register Method, look at InternalInterfaces.cs and 1. CARDS section in ModEntry */
    public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("AdamantiumSkin", new()
        {
            ...
            Name = ModEntry.Instance.AnyLoc.Bind(["card", "AdamantiumSkin", "name"]).Localize
        });
    }
