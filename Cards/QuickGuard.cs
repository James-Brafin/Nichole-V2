...
internal sealed class QuickGuard : Card, ICard, IHasCustomCardTraits
{
    ...
    public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("QuickGuard", new()
        {
            ...
            Name = ModEntry.Instance.AnyLoc.Bind(["card", "QuickGuard", "name"]).Localize
        });
    }
