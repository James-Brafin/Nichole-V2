...
internal sealed class ReagentDupe : Card, ICard
{
    ...
    public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("ReagentDupe", new()
        {
            ...
            Name = ModEntry.Instance.AnyLoc.Bind(["card", "ReagentDupe", "name"]).Localize
        });
    }
