...
internal sealed class ConfusingFumes : Card, ICard
{
    ...
    public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("ConfusingFumes", new()
        {
            ...
            Name = ModEntry.Instance.AnyLoc.Bind(["card", "ConfusingFumes", "name"]).Localize
        });
    }
