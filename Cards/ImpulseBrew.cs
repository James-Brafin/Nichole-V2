...
internal sealed class ImpulseBrew : Card, ICard
{
    ...
    public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("ImpulseBrew", new()
        {
            ...
            Name = ModEntry.Instance.AnyLoc.Bind(["card", "ImpulseBrew", "name"]).Localize
        });
    }
