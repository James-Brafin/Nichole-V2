...
internal sealed class ChemicalReaction : Card, ICard
{
    ...
    public static void Register(IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("ChemicalReaction", new()
        {
            ...
            Name = ModEntry.Instance.AnyLoc.Bind(["card", "ChemicalReaction", "name"]).Localize
        });
    }
